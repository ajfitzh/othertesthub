...
function testStoryline(){
    ...
    let dialogueList = [
        ...
        },
        {
            ...
            text: `You come to the door of your Police Captain, Captain McKickles. He's tough. But you're tougher. You sheath your <strong>${weaponName}</strong>.`  
        },
        {
            id: 3,
        ...
        },
        {
            id: 6,
            image_source: "./assets/storylineassets/KickPuncher.jpg",
            text: `<strong>${storylineName}</strong>: "I can't. Not after Vietnam."`  
        },
        {
            id: 7,
            image_source: "/assets/storylineassets/TheCaptain.jpg",
        ...
        },
        {
            ...
            text: `<strong>The President</strong>: "Thank God you're here, ${storylineName}. I got a terrorist message, it says...' ${presidentFact}'."`
        },
        {
            id: 10,
            image_source: "/assets/storylineassets/TheCaptain.jpg",
